...
def mean_bar_plus_conf(clip,xlabels,ax=None):
    '''
    ...
    my=max([v+conf[i] for i,v in enumerate(values)])
    myy=max(clip['disc'].flat)
    ax=connected_lines([0,1,2],clip['disc'],ax=ax,color='k')
