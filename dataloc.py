...
def dir(basepath,inc=[],exc = []):
    """ Using the input file path "basepath,"
    return the directory locations for all mice that
    match the criteria of "inc" list of strings and "exc" string list (optional)
    See: gen_paths_recurse() for further help.
    >>>
    """
    return gen_paths_recurse(basepath,inc,exc)
    ...
    if ver == 0: # Updated through 4/20/2020
        full_exp = {'stim_area':['Str','GPe','GPe_and_Str', 'SNr','SNr_and_Str','GPe_and_SNr'],
                    ...
                    'protocol':['zone_1','zone_2','10x10','10x30','5x30','10x30_0p5mw',
                                ...
                                '60min_psem','60min_saline','zone_2_0p25mw'],
                    }
    return full_exp
